...
## Runtime evidence
The supplied Render logs showed the previous release was still returning 503 from /, /call and /knowledge while reporting missing admin credentials. The v1.4.8 code path removes this failure mode for the public-demo deployment. A fresh Render deploy of this exact commit is required to verify the live service.
